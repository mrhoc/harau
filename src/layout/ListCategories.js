        ...
        <div id="category" className="desktop__CategoryWrapper-sc-1ligtl5-6 kZalnp">
                            <nav className="desktop__CategoryNavContainer-sc-1ligtl5-4 eImZgp">
                                <ul className="ant-menu ant-menu-light ant-menu-root ant-menu-vertical" role="menu">
                                    <li className="ant-menu-submenu ant-menu-submenu-vertical desktop__SubMenu-sc-1ligtl5-8 jpyfpc" role="menuitem">
                                        <div className="ant-menu-submenu-title selected" aria-expanded="false" aria-haspopup="true"><a href="/market">
                                        ...
                                        </a><i className="ant-menu-submenu-arrow" /></div>
                                    </li>
                                    {categories&&categories.map(category=><li className="selected ant-menu-submenu ant-menu-submenu-vertical desktop__SubMenu-sc-1ligtl5-8 jpyfpc" role="menuitem">
                                        <div className="ant-menu-submenu-title" aria-expanded="false" aria-haspopup="true"><a href={`/market?category=${category.code}`}>
                                            <div className="desktop__LabelWrapper-sc-1ligtl5-3 BLWCH">
                                                <div className="SVGIcon-uyvh4z-0 desktop__Icon-sc-1ligtl5-0 bYInAU">
                                                    <div>
