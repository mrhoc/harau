    ...
    return (
        <>
            <div className="PageHeader__Container-sc-19x4r8h-1 fVgVuB">
                                <h2 className="PageHeader__Header-sc-19x4r8h-0 jTfioR">Thịt</h2>
                            </div>
                            <div className="ant-row MarketPage__ProductListRow-x35qcj-4 eUijMD" style={{ margin: '-12px' }}>
                                <div className="ant-col ant-col-md-8 ant-col-xl-6" style={{ padding: 12 }}>
                                    <article title="Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods (1kg/túi)" className="Card-gwofcb-0 MarketItem__Container-rr0c4s-0 gpLETI">
                                            ...
                                            <div className="MarketItem__CardLinkContent-rr0c4s-3 hZWvVs">
                                                ...
                                                <div>
                                                    <div className="MarketItem__ImageContainer-rr0c4s-4 kVlklV" style={{ position: 'relative' }}>
                                                        <div className="Image__ImageWrapper-sc-791h2a-0 kgJdMp"><img loading="lazy" src="https://images-handler.kamereo.vn/eyJidWNrZXQiOiJpbWFnZS1oYW5kbGVyLXByb2QiLCJrZXkiOiJzdXBwbGllci82NTQvUFJPRFVDVF9JTUFHRS81NDMxNDRhYi01ZmI1LTQ3YTktYTMzNi1iMzEwNjBhNzZiYzIuanBnIn0=" alt="Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods (1kg/túi)" className="Image__RImage-sc-791h2a-1 kcjXoq" />
                                                        </div>
                                                ...
                                                <div style={{ flex: '1 1 0%' }}>
                                                    <div className="DetailsContainer__DetailsContainerInner-ignkyn-0 cMtGcM">
                                                        <h3 title="Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods (1kg/túi)" className="Details__Header-deqbu8-1 kvvVZC">
                                                            <div className="Details__Title-deqbu8-0 ekhIHk">Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods
                                                                (1kg/túi)
                                                            </div>
                                                        </h3>
                                                        <div className="Details__PriceContainer-deqbu8-4 kUescO">
                                                            <div className="Price__PriceContainer-pje2yp-1 kfgZzF"><p className="Price__PriceText-pje2yp-0 hdfLLI">242,000đ/Gói</p></div>
                                                        </div>
                                ...
                                <div className="ant-col ant-col-md-8 ant-col-xl-6" style={{ padding: 12 }}>
                                    <article title="Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods (250g/Túi)" className="Card-gwofcb-0 MarketItem__Container-rr0c4s-0 gpLETI">
                                        <div className="CardLink__Container-dqor2y-0 jRvebg">
                                            <div className="MarketItem__CardLinkContent-rr0c4s-3 hZWvVs">
                                                <button type="button" className="ant-btn Button-jgr7l8-0 Favorite-tn0i37-1 hrXIPJ ant-btn-secondary ant-btn-circle"><a href="/signin">
                                                    <div className="SVGIcon-uyvh4z-0 Favorite__FavoriteIcon-tn0i37-0 cCZxdL">
                                                ...
                                                <div>
                                                    <div className="MarketItem__ImageContainer-rr0c4s-4 kVlklV" style={{ position: 'relative' }}>
                                                        <div className="Image__ImageWrapper-sc-791h2a-0 kgJdMp"><img loading="lazy" src="https://images-handler.kamereo.vn/eyJidWNrZXQiOiJpbWFnZS1oYW5kbGVyLXByb2QiLCJrZXkiOiJzdXBwbGllci82NTQvUFJPRFVDVF9JTUFHRS9mZWM0ZjY4NC1hYTQ0LTQzOTAtYmFjZi02OGQ5YzYxOGRhMDYuanBnIn0=" alt="Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods (250g/Túi)" className="Image__RImage-sc-791h2a-1 kcjXoq" />
                                                        </div>
                                                        <div className="MarketItem__TagContainer-rr0c4s-1 cfFbiK" />
                                                    </div>
                                                </div>
                                                <div style={{ flex: '1 1 0%' }}>
                                                    <div className="DetailsContainer__DetailsContainerInner-ignkyn-0 cMtGcM">
                                                        <h3 title="Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods (250g/Túi)" className="Details__Header-deqbu8-1 kvvVZC">
                                                            <div className="Details__Title-deqbu8-0 ekhIHk">Ba Rọi Heo Cắt Lát Đông Lạnh 2mm NH Foods
                                                                (250g/Túi)
                                                            </div>
                                                        </h3>
                                                        <div className="Details__PriceContainer-deqbu8-4 kUescO">
                                                            <div className="Price__PriceContainer-pje2yp-1 kfgZzF"><p className="Price__PriceText-pje2yp-0 hdfLLI">62,000đ/Gói</p></div>
                                                        </div>
                                                        <div className="Details__FooterContainer-deqbu8-2 TkwlX">
                                                            <div className="Details__FlexContainer-deqbu8-3 hkVFdU">
                                                                <div className="ProductNote__NoteAction-sc-1ht25tx-1 zgsGq">
                                ...
                                <div className="ant-col ant-col-md-8 ant-col-xl-6" style={{ padding: 12 }}>
                                    <article title="Ba Rọi Xông Khói NH Foods (1kg/túi)" className="Card-gwofcb-0 MarketItem__Container-rr0c4s-0 gpLETI">
                                        <div className="CardLink__Container-dqor2y-0 jRvebg">
                                            <div className="MarketItem__CardLinkContent-rr0c4s-3 hZWvVs">
                                                <button type="button" className="ant-btn Button-jgr7l8-0 Favorite-tn0i37-1 hrXIPJ ant-btn-secondary ant-btn-circle"><a href="/signin">
                                                    <div className="SVGIcon-uyvh4z-0 Favorite__FavoriteIcon-tn0i37-0 cCZxdL">
                                                ...
                                                <div>
                                                    <div className="MarketItem__ImageContainer-rr0c4s-4 kVlklV" style={{ position: 'relative' }}>
                                                        <div className="Image__ImageWrapper-sc-791h2a-0 kgJdMp"><img loading="lazy" src="https://images-handler.kamereo.vn/eyJidWNrZXQiOiJpbWFnZS1oYW5kbGVyLXByb2QiLCJrZXkiOiJzdXBwbGllci82NTQvUFJPRFVDVF9JTUFHRS82OWU3OTA2MS0xMjI0LTQ5Y2ItOWFmMC0xZjg5YWM3YmEzODMuanBnIn0=" alt="Ba Rọi Xông Khói NH Foods (1kg/túi)" className="Image__RImage-sc-791h2a-1 kcjXoq" />
                                                        </div>
                                                ...
                                                <div style={{ flex: '1 1 0%' }}>
                                                    <div className="DetailsContainer__DetailsContainerInner-ignkyn-0 cMtGcM">
                                                        <h3 title="Ba Rọi Xông Khói NH Foods (1kg/túi)" className="Details__Header-deqbu8-1 kvvVZC">
                                                            <div className="Details__Title-deqbu8-0 ekhIHk">Ba Rọi Xông Khói NH Foods (1kg/túi)</div>
                                                        </h3>
                                                        <div className="Details__PriceContainer-deqbu8-4 kUescO">
                                                            <div className="Price__PriceContainer-pje2yp-1 kfgZzF"><p className="Price__PriceText-pje2yp-0 hdfLLI">209,000đ/Gói</p></div>
                                                        </div>
                                                        <div className="Details__FooterContainer-deqbu8-2 TkwlX">
                                                            <div className="Details__FlexContainer-deqbu8-3 hkVFdU">
                                                                <div className="ProductNote__NoteAction-sc-1ht25tx-1 zgsGq">
