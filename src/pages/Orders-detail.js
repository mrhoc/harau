...
const OrdersDetail = () => {
    ...
    const { ordersKey,setdetail,detail } = useAppContext;
    useEffect(() => {
                    ...
                    <div className="ant-card-body">
                        ...
                        <div className="ant-row" style={{ marginLeft: '-4px', marginRight: '-4px' }}>
                            ...
                            <div className="ant-col ant-col-sm-12 ant-col-lg-8" style={{ paddingLeft: 4, paddingRight: 4 }}>
                                ...
                                <div className="OrderSummary__InfoRow-ugckj3-0 cVHuBw"><span className="styledComponents__Label-cp2vq4-2 gjrqGn"><span>Tổng số sản phẩm</span></span><span className="OrderSummary__Value-ugckj3-4 dTwnQL">{}</span></div>
