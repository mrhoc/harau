                ...
                <div className="GateLayout__Content-cr7ybx-1 jdPVrB">
                    ...
                    <div className="GateLayout__DownloadAppContainer-cr7ybx-8 hLkNwS">
                        <div className="DownloadApp__Container-sc-18txisl-0 fFuSo"><p><span>Đặt hàng mọi lúc, mọi nơi thông qua ứng dụng của chúng tôi:</span>
                            ...
                            <div className="DownloadApp__StoreContainer-sc-18txisl-1 liFjBl"><a href="https://apps.apple.com/us/app/kamereo/id1469505654" target="_blank"><img src="/static/media/AppStore.76c5b55d.svg" className="DownloadApp__AppStoreImage-sc-18txisl-2 gFLAxF" /></a><a href="https://play.google.com/store/apps/details?id=vn.kamereo.buyer" target="_blank"><img src="/static/media/GoogleStore.cb918cd4.svg" className="DownloadApp__GoogleStoreImage-sc-18txisl-3 ebLbRP" /></a></div>
                        </div>
                    </div>
                </div>
                <div className="GateLayout__Bg-cr7ybx-2 fDxdCa"><img src="/adea69c8d35c1cfa32ee173db7ac457b.png" className="GateLayout__ImageTopLeft-cr7ybx-3 hHcaRl" /><img src="/a1951685fa3474f6eb8c306adbe6204a.png" className="GateLayout__ImageTopRight-cr7ybx-4 eZkJsz" /><img src="/ba2622d292e9341b265ded7245853198.png" className="GateLayout__ImageBottomLeft-cr7ybx-5 hwiqXA" /><img src="/482c967e50fef21791147c113f4a4afb.png" className="GateLayout__ImageBottomRight-cr7ybx-6 ioIsJo" /></div>
            </div>
        </div>
